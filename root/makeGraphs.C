...
void makeGraphs(TString inputdir = "/eos/cms/store/group/dpg_csc/comm_csc/cscval/condor_output/SingleMuon/run355870_RAW", int maxfiles = 300) {
  ...
  segchain->Add(inputdir+"/valHists_run355870_SingleMuon_*.root");
